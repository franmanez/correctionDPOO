...
class MovieTest {
    ...
    void checkMethodsSanity() {
        ...
        assertEquals(10, movieClass.getDeclaredFields().length);
        ...
        try {
            assertEquals(14,movieClass.getDeclaredMethods().length);
            assertEquals(13, Arrays.stream(movieClass.getDeclaredMethods()).filter(m -> Modifier.isPublic(m.getModifiers())).count());
