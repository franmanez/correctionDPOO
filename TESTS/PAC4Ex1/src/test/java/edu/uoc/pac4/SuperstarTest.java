...
class SuperstarTest {
    ...
    public void checkMethodsSanity() {
        ...
        try {
            ...
            assertTrue(Modifier.isPublic(ownClass.getDeclaredConstructor(String.class, LocalDate.class, String.class, Gender.class, double.class, double.class, String.class).getModifiers()));
